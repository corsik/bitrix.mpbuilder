...
?>
	...
	<tr>
		...
		<td><input name="version" value="<?=htmlspecialcharsbx(VersionUp($arModuleVersion['VERSION']))?>" id='version_field' disabled> <label><input type=checkbox onchange="document.getElementById('version_field').disabled=!this.checked"> <?=GetMessage("BITRIX_MPBUILDER_OBNOVITQ_VERSIU")?></label></td>
