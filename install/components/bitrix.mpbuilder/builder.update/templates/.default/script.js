...
(function (exports) {
	...
	var BuilderUpdateApp = {
	  ...
	  methods: {
	    ...
	    applyAutoBlock: function applyAutoBlock(data) {
	      var AUTO_START = '// @mpbuilder-auto-start';
	      var AUTO_END = '// @mpbuilder-auto-end';
	      var moduleId = data.moduleId || this.selectedModuleId;
	      var namespace = this.namespace || moduleId;
	      var installDirMap = {
	        components: "\"components/".concat(namespace, "/\""),
	        js: "\"js/".concat(moduleId, "/\""),
	        css: "\"css/".concat(moduleId, "/\""),
	        admin: '"admin/"',
	        themes: '"themes/"',
	        images: "\"images/".concat(moduleId, "/\"")
	      };
	      var lines = [];
	      ...
	      if ((data.changedInstallDirs || []).length > 0 || (data.deletedFiles || []).length > 0) {
	        ...
	        var _iterator = _createForOfIteratorHelper(data.changedInstallDirs || []),
	          _step;
	        try {
	          for (_iterator.s(); !(_step = _iterator.n()).done;) {
	            var dir = _step.value;
	            var dst = installDirMap[dir] || "\"modules/".concat(moduleId, "/install/").concat(dir, "/\"");
	            lines.push("    if (is_dir(dirname(__FILE__) . '/install/".concat(dir, "')) {"));
	            lines.push("        $updater->CopyFiles(\"install/".concat(dir, "\", ").concat(dst, ");"));
	            lines.push('    }');
	            lines.push('');
	          }
	        } catch (err) {
	        ...
	        if (data.deletedFiles && data.deletedFiles.length > 0) {
	          lines.push("    // Files removed since ".concat(data.prevVersion || 'previous version', ":"));
	          var _iterator2 = _createForOfIteratorHelper(data.deletedFiles),
	            _step2;
	          try {
	            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
	              var file = _step2.value;
	              lines.push("    // @unlink($_SERVER['DOCUMENT_ROOT'] . '/bitrix/modules/".concat(moduleId).concat(file, "');"));
	            }
	          } catch (err) {
	            _iterator2.e(err);
	          } finally {
	      ...
	      lines.push(AUTO_END);
	      var autoBlock = lines.join('\n');
	      var current = this.updater || '';
	      var startIdx = current.indexOf(AUTO_START);
	      var endIdx = current.indexOf(AUTO_END);
	      var newUpdater;
	      if (startIdx !== -1 && endIdx !== -1 && endIdx > startIdx) {
	        newUpdater = current.substring(0, startIdx) + autoBlock + current.substring(endIdx + AUTO_END.length);
	      } else {
	        var closeIdx = current.lastIndexOf('?>');
	        if (closeIdx !== -1) {
	      ...
	      if (this.updaterEditor) {
	        var el = document.getElementById('mpb-updater-editor');
	        if (el) {
	          var _this$updaterEditor$R, _this$updaterEditor;
	          el.value = this.updater;
	          (_this$updaterEditor$R = (_this$updaterEditor = this.updaterEditor).Refresh) === null || _this$updaterEditor$R === void 0 ? void 0 : _this$updaterEditor$R.call(_this$updaterEditor);
	        }
	      }
	    },
	    ...
	    refreshEditors: function refreshEditors() {
	      if (this.descriptionEditor) {
	        var el = document.getElementById('mpb-description-editor');
	        if (el) {
	          var _this$descriptionEdit, _this$descriptionEdit2;
	          el.value = this.description;
	          (_this$descriptionEdit = (_this$descriptionEdit2 = this.descriptionEditor).Refresh) === null || _this$descriptionEdit === void 0 ? void 0 : _this$descriptionEdit.call(_this$descriptionEdit2);
	        }
	      }
	      if (this.updaterEditor) {
	        var _el2 = document.getElementById('mpb-updater-editor');
	        if (_el2) {
	          var _this$updaterEditor$R2, _this$updaterEditor2;
	          _el2.value = this.updater;
	          (_this$updaterEditor$R2 = (_this$updaterEditor2 = this.updaterEditor).Refresh) === null || _this$updaterEditor$R2 === void 0 ? void 0 : _this$updaterEditor$R2.call(_this$updaterEditor2);
	        }
	      }
	    },
	      ...
	      return babelHelpers.asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
	        ...
	        return _regeneratorRuntime().wrap(function _callee10$(_context10) {
	          while (1) switch (_context10.prev = _context10.next) {
	            case 0:
	              if (confirm(_this10.loc('MPBUILDER_UPDATE_RESTORE_CONFIRM'))) {
	                _context10.next = 2;
	                break;
	              }
	            ...
	            case 2:
	              _context10.prev = 2;
	              _context10.next = 5;
	              return _this10.runAction('restoreVersion', {
	                moduleId: _this10.selectedModuleId
	              });
	            case 5:
	              response = _context10.sent;
	              if (response.data) {
	                _this10.loadModuleInfo(_this10.selectedModuleId);
	              }
	              _context10.next = 12;
	              break;
	            case 9:
